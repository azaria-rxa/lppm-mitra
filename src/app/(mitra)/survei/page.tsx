...
export default function DaftarSurveiPage() {
  const { data, error, isLoading } = useSWR<SurveiTersedia[]>("/api/survei/tersedia", fetcher, {
  ...
  return (
    <div className="space-y-4">
      ...
      {error && (
        <Card>
          <CardContent className="p-4 text-sm text-red-600">Gagal memuat survei.</CardContent>
        </Card>
      )}
